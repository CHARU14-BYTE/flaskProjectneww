...
for file in os.listdir('C:\\Users\\charu\\PycharmProjects\\flaskProject1\\data\\data'):
    chats = open('C:\\Users\\charu\\PycharmProjects\\flaskProject1\\data\\data\\' + file, 'r').readlines()
    trainer.train(chats)
